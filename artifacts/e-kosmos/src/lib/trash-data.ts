...
export const TRASH_ITEMS: TrashItem[] = [
  ...
  { id: 'v3',  name: 'Barattolo di marmellata', emoji: '🫙', image: 'jam_jar.svg',             categoryId: 'vetro' },
  ...
  { id: 'm5',  name: 'Tetrapak del latte',     emoji: '🥛', image: 'milk_tetrapak.svg',        categoryId: 'multimateriale' },
  { id: 'm6',  name: 'Lattina di birra',       emoji: '🍺', image: 'beer_can.png',             categoryId: 'multimateriale' },
  { id: 'm7',  name: 'Flacone di shampoo',     emoji: '🧴', image: 'shampoo_bottle.svg',       categoryId: 'multimateriale' },
  ...
  { id: 'i6',  name: 'Penna a sfera esaurita', emoji: '🖊️', image: 'empty_pen.svg',           categoryId: 'indifferenziato' },
  { id: 'i7',  name: 'Accendino esaurito',     emoji: '🔥', image: 'lighter.svg',             categoryId: 'indifferenziato' },
  ...
  { id: 'i14', name: 'Carta da cucina unta',   emoji: '🍕', image: 'greasy_paper.svg',        categoryId: 'indifferenziato' },
  { id: 'i15', name: 'Nastro adesivo',         emoji: '📎', image: 'tape.svg',                categoryId: 'indifferenziato' },
